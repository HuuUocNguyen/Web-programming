 ...
 * @author User
 */
// các phương thức cho lớp giỏ hàng như thêm sản phẩm vào giỏ hàng, cập nhật giỏ hàng, xóa giỏ hàng, tính tổng số lượng sản phẩm và tổng tiền có trong giỏ hàng.
public class Cart {
    ...
    public void plusToCart(Long key, Item item) {
        ...
        if (bln) { // neu da co san pham do roi thi cong them
