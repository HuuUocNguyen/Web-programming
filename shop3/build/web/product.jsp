<%-- 
    Document   : product
    Created on : Dec 2, 2018, 2:32:37 PM
    Author     : User
--%>
...
<html>
    ...
    <body>
        <%
            ...
            // hiển thị sản phẩm theo danh mục, truyền tham số mã danh mục từ trang category.jsp sang trang product.jsp
            long categoryID = 0;
            ...
            ArrayList<Product> listProduct = productDAO.getListProductByPages((categoryID), firstResult, maxResult);
        %>
