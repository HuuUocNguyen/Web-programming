<%-- 
    Document   : detail
    Created on : Dec 3, 2018, 10:04:10 AM
    Author     : User
--%>
...
<html>
    ...
    <body>
        <!--truyền mã sản phẩm qua trang chi tiết, Sử dụng phương thức getParameter() để lấy dữ liệu. -->
        <%
        ...
        <jsp:include page="header.jsp"></jsp:include>
            ...
            <div class="container">
                <div class="single">
                    ...
                    <div>
                        <div class="fb-comments" data-href="http://localhost:8080/shop2/single.jsp?productID=<%=productID %> $>" data-width="700" data-numposts="5"></div>
                    </div>
                </div>
                <div class="col-md-3">
