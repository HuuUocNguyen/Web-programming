<%-- 
    Document   : banner
    Created on : Dec 2, 2018, 2:08:46 PM
    Author     : User
--%>
                ...
                <div class="banner">
                    ...
                    <div class="slider">
                        <ul class="rslides" id="slider1">
                            <li><img src="images/macbook pro banner.jpg" alt="">
                            </li>
                            <li><img src="images/google laptop banner.jpg" alt="">
                            </li>
                            <li><img src="images/pic8.jpg" alt="">
                            </li>
                            <li><img src="images/HP.jpg" alt="">
                            </li>
                        </ul>
                    </div>
